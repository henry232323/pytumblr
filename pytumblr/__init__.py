...
class TumblrRestClient(object):
    ...
    def __init__(self,
        ...
        """
        self.loop = loop
        self.request = TumblrRequest(loop, consumer_key, consumer_secret, oauth_token, oauth_secret, host)

    def info(self) -> Awaitable:
        """
        Gets the information about the current given user
        :returns: a coroutine, can be awaited for the response
        """
        return self.send_api_request("get", "/v2/user/info")

    @validate_blogname
    def avatar(self, blogname: str, size: int=64) -> Awaitable:
        """
    ...
    def likes(self, **kwargs) -> Awaitable:
        """
    ...
    def following(self, **kwargs) -> Awaitable:
        """
    ...
    def dashboard(self, **kwargs) -> Awaitable:
        """
    ...
    def tagged(self, tag: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def posts(self, blogname: str, type: Union[str, List[str]]=None, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def blog_info(self, blogname: str) -> Awaitable:
        """
        ...
        :returns: a coroutine, can be awaited for the response of information
        """
        url = "/v2/blog/{0}/info".format(blogname)
        return self.send_api_request("get", url, {}, ['api_key'], True)

    @validate_blogname
    def blog_following(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def followers(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def blog_likes(self, blogname: str, **kwargs) -> Awaitable:
        """
        Gets the current given user's likes
        :param limit: an int, the number of likes you want returned
        (DEPRECATED) :param offset: an int, the like you want to start at, for pagination.
    ...
    @validate_blogname
    def queue(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def drafts(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def submission(self, blogname: str, **kwargs) -> Awaitable:
        """
        Gets posts that are currently in the blog's queue
        :param offset: an int, the post you want to start at, for pagination.
        :param filter: the post format that you want returned: HTML, text, raw.
    ...
    @validate_blogname
    def follow(self, blogname: str) -> Awaitable:
        """
    ...
    @validate_blogname
    def unfollow(self, blogname: str) -> Awaitable:
        """
    ...
    def like(self, id: int, reblog_key: str) -> Awaitable:
        """
    ...
    def unlike(self, id: int, reblog_key: str) -> Awaitable:
        """
    ...
    @validate_blogname
    def create_photo(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def create_text(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def create_quote(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def create_link(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def create_chat(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def create_audio(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def create_video(self, blogname: str, **kwargs) -> Awaitable:
        """
        Create a audio post on a blog
        :param blogname: a string, the url of the blog you want to post to.
        :param state: a string, The state of the post.
    ...
    @validate_blogname
    def reblog(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    @validate_blogname
    def delete_post(self, blogname: str, id: int) -> Awaitable:
        """
    ...
    @validate_blogname
    def edit_post(self, blogname: str, **kwargs) -> Awaitable:
        """
    ...
    def _post_valid_options(self, post_type: str=None):
    ...
    def _send_post(self, blogname: str, params: dict) -> Awaitable:
        """
    ...
    def send_api_request(self,
                         ...
                         needs_api_key: bool=False) -> Awaitable:
        """
